...
echo_and_run cd "/home/zpj/ladar_and_camera_fusion/src/Kalibr/aslam_incremental_calibration/incremental_calibration_python"
...
echo_and_run /usr/bin/env \
    ...
    "/home/zpj/ladar_and_camera_fusion/src/Kalibr/aslam_incremental_calibration/incremental_calibration_python/setup.py" \
     \
    build --build-base "/home/zpj/ladar_and_camera_fusion/build/Kalibr/aslam_incremental_calibration/incremental_calibration_python" \
    install \
    --root="${DESTDIR-/}" \
