...
echo_and_run cd "/home/zpj/ladar_and_camera_fusion/src/Kalibr/aslam_cv/aslam_cameras_april"
...
echo_and_run /usr/bin/env \
    ...
    "/home/zpj/ladar_and_camera_fusion/src/Kalibr/aslam_cv/aslam_cameras_april/setup.py" \
     \
    build --build-base "/home/zpj/ladar_and_camera_fusion/build/Kalibr/aslam_cv/aslam_cameras_april" \
    install \
    --root="${DESTDIR-/}" \
