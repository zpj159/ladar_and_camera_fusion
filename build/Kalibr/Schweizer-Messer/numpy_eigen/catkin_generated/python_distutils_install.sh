...
echo_and_run cd "/home/zpj/ladar_and_camera_fusion/src/Kalibr/Schweizer-Messer/numpy_eigen"
...
echo_and_run /usr/bin/env \
    ...
    "/home/zpj/ladar_and_camera_fusion/src/Kalibr/Schweizer-Messer/numpy_eigen/setup.py" \
     \
    build --build-base "/home/zpj/ladar_and_camera_fusion/build/Kalibr/Schweizer-Messer/numpy_eigen" \
    install \
    --root="${DESTDIR-/}" \
