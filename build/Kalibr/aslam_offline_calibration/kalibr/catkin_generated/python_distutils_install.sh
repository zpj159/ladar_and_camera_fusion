...
echo_and_run cd "/home/zpj/ladar_and_camera_fusion/src/Kalibr/aslam_offline_calibration/kalibr"
...
echo_and_run /usr/bin/env \
    ...
    "/home/zpj/ladar_and_camera_fusion/src/Kalibr/aslam_offline_calibration/kalibr/setup.py" \
     \
    build --build-base "/home/zpj/ladar_and_camera_fusion/build/Kalibr/aslam_offline_calibration/kalibr" \
    install \
    --root="${DESTDIR-/}" \
